    ...
    <View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.bodyText}>
          We care about your privacy and want to make sure you understand how we
          handle your information when using our app. Below, we explain what
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.bodyText}>
          Feynman AI is powered by Feynman, LLC, self-funded company focused on
          providing you with a smooth, reliable note-taking experience.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.listItem}>
          ...
          <View style={styles.listContent}>
            <Text style={styles.listTitle}>Audio Recordings and Files:</Text>
            <Text style={styles.bodyText}>
        ...
        <View style={styles.listItem}>
          ...
          <View style={styles.listContent}>
            ...
            <Text style={styles.bodyText}>
              To keep Feynman running efficiently, we collect minimal data such
              as the number of notes you create. We use third-party services to
        ...
        <View style={styles.listItem}>
          ...
          <View style={styles.listContent}>
            ...
            <Text style={styles.bodyText}>
              We collect user data such as email, name, and profile picture. This
              data is used to personalize your experience and is not shared with
              third parties.
            </Text>
          </View>
        </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.bodyText}>
          ...
          beacons, across our website, services, or apps. However, we do use some
          in-house cookies to improve functionality and your overall experience:
        </Text>
        ...
        <View style={styles.bulletItem}>
          ...
          <View style={styles.bulletContent}>
            ...
            <Text style={styles.bodyText}>
              These help ensure data flows smoothly across our platform and assist
              in identifying and fixing any errors.
            </Text>
          </View>
        </View>
        ...
        <View style={styles.bulletItem}>
          ...
          <View style={styles.bulletContent}>
            ...
            <Text style={styles.bodyText}>
              ...
              language preferences or transaction verification, ensuring the app
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.bodyText}>
          ...
          disabling cookies might affect certain features on our website and app.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.bodyText}>
          Most of the data we collect through cookies is non-personal. If local
          laws treat things like IP addresses as personal data, we apply the same
          protections to them as we would with other personal information.
        </Text>
        <Text style={styles.bodyText}>
          In some cases, we might combine non-personal data collected through
          cookies with personal data we already have. In such cases, this combined
          data is treated as personal information and protected under this Privacy
          Policy.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.bodyText}>
          We rely on a few trusted third-party services to help manage and enhance
          our app:
        </Text>
        ...
        <View style={styles.linkItem}>
          ...
          <TouchableOpacity
            onPress={() => openLink("https://www.revenuecat.com/privacy")}
          >
            <Text style={styles.linkText}>Privacy Policy</Text>
          </TouchableOpacity>
        </View>
        ...
        <Text style={styles.bodyText}>
          These services may collect or process some of your data, so please refer
          to their policies for more details.
        </Text>
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.bodyText}>
          Any advertisements shown through our own platform while using Feynman AI
          are designed to respect your privacy. These ads don&apos;t track or share
      ...
      <View style={styles.section}>
        ...
        <View style={styles.bulletItem}>
          ...
          <View style={styles.bulletContent}>
            ...
            <Text style={styles.bodyText}>
              If you have any questions or need help, feel free to email us at{" "}
            </Text>
      ...
      <View style={styles.section}>
        <Text style={styles.bodyText}>
          Thank you for choosing Feynman AI! We&apos;re here to support you on your
          note-taking journey.
        </Text>
      </View>
